...
a:hover{background-color:#5b5e5b }
    ...
    <div class="top">
      ...
      <a href="login.php" style="float:right" class="bar-item button">Login</a>
      </div>
    ...
    <a href="Housebuy.php"><img src="snip1.PNG" alt="Mountain View" hspace="100" style="width:288px;height:228px;padding-top:180px;" class="grow"></a>
    <a href="Flatbuy.php"><img src="snip2.PNG" alt="Mountain View" hspace="50" style="width:288px;height:228px;" class="grow"></a>
    <a href="Luxurybuy.php"><img src="snip4.PNG" alt="Mountain View" hspace="60" style="width:288px;height:228px;" class="grow"></a>
    </header>
    </body>
    </html>