...
$con = mysqli_connect($server,$user,$password,"contact") or die("Failed to connect to MySQL: " ); 
...
function SignUp($con) 
	 	{ 
	 		...
	 		{ 
                ...
                $Name = $_POST['name']; 
                $number = $_POST['comments']; 
                $email = $_POST['email']; 
               
                
                    
                   $query = "INSERT INTO cont (name,email,comment) VALUES ('$Name','$email','$number')"; 
...
<h1 style="color:white">We will get back to you shortly.</h1>
</center>
</body>
</html>
