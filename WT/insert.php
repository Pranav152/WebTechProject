...
$con = mysqli_connect($server,$user,$password,"dat") or die("Failed to connect to MySQL: " ); 
	 	...
	 	{ 
	 		...
	 		{ 
                ...
                $email = $_POST['Email']; 
                   ...
                   $query = "INSERT INTO asd (Name,email,num) VALUES ('$Name','$email','$number')"; 
...
<center>
<br><br><br>
<img src="buy.jpg" width="400px" height="325px">
<h1 style="color:white">The Builder will be in contact with you shortly.</h1>
</center>
</body>
</html>
