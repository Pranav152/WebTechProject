...
$con = mysqli_connect($server,$user,$password,"sell") or die("Failed to connect to MySQL: " ); 
	 	...
	 	{ 
	 		...
	 		{ 
                ...
                $email = $_POST['location']; 
                   ...
                   $query = "INSERT INTO sellindex (first,last,location) VALUES ('$Name','$number','$email')"; 
